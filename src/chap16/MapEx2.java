...
public class MapEx2 {
   ...
   public static void main(String[] args) throws IOException {
      ...
      //Stream<String> br.lines() : br 변수가 참조하는 파일의 내용을 라인별로 Stream<String> 객체로 생성
      //2. 파일의 내용을 Car 객체의 스트림으로 변경
      ...
      }).filter(s->s.getCar().equals("그랜저")).forEach(s->System.out.println(s));
   }
}