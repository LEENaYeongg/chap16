...
public class StreamEx2 {
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		//mapToInt : Stream = > IntStreamÇüÀ¸·Î º¯È¯
		//sum() : IntStreamÀÇ ¿ä¼ÒÀÇ ÇÕ ¸®ÅÏ
		
//		System.out.println("¼öÇÐÁ¡¼öÃÑÁ¡: "+ list.stream().mapToInt(Student::getMath).sum());
		System.out.println("¼öÇÐÁ¡¼öÃÑÁ¡: "+list.stream().mapToInt(s->s.getMath()).sum());
		System.out.println("¿µ¾îÁ¡¼öÃÑÁ¡: "+ list.stream().mapToInt(Student::getEng).sum());
	}
